...
//            int locationIndex = locationCursor.getColumnIndex(WeatherContract.LocationEntry._ID);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting) throws JSONException {
        ...
        try {
            ...
            // add to database
            if ( cVVector.size() > 0 ) {
                insertCount = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cVVector.toArray(new ContentValues[cVVector.size()]));
                // Student: call bulkInsert to add the weatherEntries to the database here
            }
            Log.d(LOG_TAG, "FetchWeatherTask , insertCount: " + insertCount);

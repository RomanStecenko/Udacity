...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public long insertLocation() {
        ...
        assertTrue("Error: testLocationTable() locationRowId", locationRowId != -1);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: validateCurrentRecord: ", cursor, contentValues);
//        TestUtilities.validateCursor("Error: validateCurrentRecord: ", cursor, contentValues);
...
//        long locationRowId = testLocationTable();
        ...
        assertTrue("Error: testWeatherTable() locationRowId", locationRowId != -1);
        ...
        assertTrue("Error: testWeatherTable() weatherRowId", weatherRowId != -1);
